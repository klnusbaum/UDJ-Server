package org.klnusbaum.udj.PullToRefresh;
 ...
 */
public abstract class RefreshableListFragment extends Fragment {
	...
	final private AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View v, int position,
				long id) {
			onListItemClick((ListView) parent, v, position-1, id);
		}
	};
	...
	protected abstract void doRefreshWork();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		PullToRefreshListView lv = (PullToRefreshListView) inflater.inflate(
				R.layout.pull_to_refresh_listview, null);
