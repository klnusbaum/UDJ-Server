...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.allow_user_songset'
        db.add_column('udj_player', 'allow_user_songset',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Player.allow_user_songset'
        db.delete_column('udj_player', 'allow_user_songset')
