...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Library.resolver'
        db.add_column('udj_library', 'resolver',
                      self.gf('django.db.models.fields.CharField')(default='standard', max_length=200),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Library.resolver'
        db.delete_column('udj_library', 'resolver')
