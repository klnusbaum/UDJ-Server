...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalLibrary.resolverClass'
        db.add_column('udj_externallibrary', 'resolverClass',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ExternalLibrary.resolverClass'
        db.delete_column('udj_externallibrary', 'resolverClass')
    ...
    models = {
        ...
        'udj.externallibrary': {
            ...
            'resolverClass': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'udj.favorite': {
