...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('udj_library', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('pub_key', self.gf('django.db.models.fields.TextField')()),
            ('read_permission', self.gf('django.db.models.fields.CharField')(default=u'OW', max_length=2)),
            ('write_permission', self.gf('django.db.models.fields.CharField')(default=u'OW', max_length=2)),
        ))
        db.send_create_signal('udj', ['Library'])

    def backwards(self, orm):
        # Deleting model 'Library'
        db.delete_table('udj_library')
