...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EnabledExternalLibrary'
        db.create_table('udj_enabledexternallibrary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.Player'])),
            ('externalLibrary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.ExternalLibrary'])),
        ))
        db.send_create_signal('udj', ['EnabledExternalLibrary'])

        # Adding unique constraint on 'EnabledExternalLibrary', fields ['player', 'externalLibrary']
        db.create_unique('udj_enabledexternallibrary', ['player_id', 'externalLibrary_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'EnabledExternalLibrary', fields ['player', 'externalLibrary']
        db.delete_unique('udj_enabledexternallibrary', ['player_id', 'externalLibrary_id'])

        # Deleting model 'EnabledExternalLibrary'
        db.delete_table('udj_enabledexternallibrary')
    ...
    models = {
        ...
        'udj.enabledexternallibrary': {
            'Meta': {'unique_together': "(('player', 'externalLibrary'),)", 'object_name': 'EnabledExternalLibrary'},
            'externalLibrary': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['udj.ExternalLibrary']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'udj.libraryentry': {
            ...
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['udj.Player']"}),
            'player_lib_song_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
