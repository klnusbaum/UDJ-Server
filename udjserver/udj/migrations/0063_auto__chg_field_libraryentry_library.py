...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LibraryEntry.library'
        db.alter_column('udj_libraryentry', 'library_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['udj.Library']))
    def backwards(self, orm):

        # Changing field 'LibraryEntry.library'
        db.alter_column('udj_libraryentry', 'library_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.Library'], null=True))
    models = {
        'auth.group': {
