...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OwnedLibrary'
        db.create_table('udj_ownedlibrary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('library', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.Library'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('udj', ['OwnedLibrary'])

    def backwards(self, orm):
        # Deleting model 'OwnedLibrary'
        db.delete_table('udj_ownedlibrary')
