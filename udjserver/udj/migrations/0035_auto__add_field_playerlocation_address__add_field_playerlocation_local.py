...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlayerLocation.locality'
        db.add_column('udj_playerlocation', 'locality',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'PlayerLocation.region'
        db.add_column('udj_playerlocation', 'region',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'PlayerLocation.postal_code'
        db.add_column('udj_playerlocation', 'postal_code',
                      self.gf('django.db.models.fields.CharField')(default='00000', max_length=100),
                      keep_default=False)

        # Adding field 'PlayerLocation.country'
        db.add_column('udj_playerlocation', 'country',
                      self.gf('django.db.models.fields.CharField')(default='U.S.', max_length=100),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PlayerLocation.locality'
        db.delete_column('udj_playerlocation', 'locality')

        # Deleting field 'PlayerLocation.region'
        db.delete_column('udj_playerlocation', 'region')

        # Deleting field 'PlayerLocation.postal_code'
        db.delete_column('udj_playerlocation', 'postal_code')

        # Deleting field 'PlayerLocation.country'
        db.delete_column('udj_playerlocation', 'country')
    ...
    models = {
        ...
        'udj.playerlocation': {
            ...
            'postal_code': ('django.db.models.fields.CharField', [], {'default': "'00000'", 'max_length': '100'}),
