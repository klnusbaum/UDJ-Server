...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalLibrary.libraryResolverClass'
        db.add_column('udj_externallibrary', 'libraryResolverClass',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ExternalLibrary.libraryResolverClass'
        db.delete_column('udj_externallibrary', 'libraryResolverClass')
    ...
    models = {
        ...
        'udj.externallibrary': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'libraryResolverClass': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
