...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('udj_playerlocation', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')())
    def backwards(self, orm):

        # Changing field 'PlayerLocation.point'
        db.alter_column('udj_playerlocation', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))
    models = {
        'auth.group': {
