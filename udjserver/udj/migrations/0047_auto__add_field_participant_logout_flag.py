...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.logout_flag'
        db.add_column('udj_participant', 'logout_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Participant.logout_flag'
        db.delete_column('udj_participant', 'logout_flag')
