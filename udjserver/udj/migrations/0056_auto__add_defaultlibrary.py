...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DefaultLibrary'
        db.create_table('udj_defaultlibrary', (
        ...
        db.send_create_signal('udj', ['DefaultLibrary'])

    def backwards(self, orm):
        # Deleting model 'DefaultLibrary'
        db.delete_table('udj_defaultlibrary')
