...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FbUser'
        db.create_table('udj_fbuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('fb_user_id', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('udj', ['FbUser'])

    def backwards(self, orm):
        # Deleting model 'FbUser'
        db.delete_table('udj_fbuser')
    ...
    models = {
        ...
        'udj.fbuser': {
            ...
            'fb_user_id': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'udj.library': {
