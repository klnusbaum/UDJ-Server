...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('udj_bannedsong', (
            ...
            ('lib_entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.LibraryEntry'])),
        ))
    ...
    models = {
        ...
        'udj.bannedsong': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lib_entry': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['udj.LibraryEntry']"})
        },
        'udj.libraryentry': {
