...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserPubKey'
        db.create_table('udj_userpubkey', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('pub_key', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('udj', ['UserPubKey'])

    def backwards(self, orm):
        # Deleting model 'UserPubKey'
        db.delete_table('udj_userpubkey')
    ...
    models = {
        ...
        'udj.userpubkey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_key': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
