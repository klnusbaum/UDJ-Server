...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BannedLibraryEntry', fields ['player', 'song']
        db.create_unique('udj_bannedlibraryentry', ['player_id', 'song_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'BannedLibraryEntry', fields ['player', 'song']
        db.delete_unique('udj_bannedlibraryentry', ['player_id', 'song_id'])
