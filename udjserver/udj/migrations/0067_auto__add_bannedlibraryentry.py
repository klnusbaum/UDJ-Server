...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BannedLibraryEntry'
        db.create_table('udj_bannedlibraryentry', (
        ...
        db.send_create_signal('udj', ['BannedLibraryEntry'])

    def backwards(self, orm):
        # Deleting model 'BannedLibraryEntry'
        db.delete_table('udj_bannedlibraryentry')
    ...
    models = {
        ...
        'udj.bannedlibraryentry': {
            'Meta': {'object_name': 'BannedLibraryEntry'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['udj.Player']"}),
            'song': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['udj.LibraryEntry']"})
        },
