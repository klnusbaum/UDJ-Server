...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Player.external_library'
        db.delete_column('udj_player', 'external_library_id')

    def backwards(self, orm):
        # Adding field 'Player.external_library'
        db.add_column('udj_player', 'external_library',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.ExternalLibrary'], null=True),
                      keep_default=False)
