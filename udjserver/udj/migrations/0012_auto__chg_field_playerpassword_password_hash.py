...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlayerPassword.password_hash'
        db.alter_column('udj_playerpassword', 'password_hash', self.gf('django.db.models.fields.CharField')(max_length=40))
    def backwards(self, orm):

        # Changing field 'PlayerPassword.password_hash'
        db.alter_column('udj_playerpassword', 'password_hash', self.gf('django.db.models.fields.CharField')(max_length=32))
    models = {
        'auth.group': {
