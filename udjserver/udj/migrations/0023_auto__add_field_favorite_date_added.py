...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Favorite.date_added'
        db.add_column('udj_favorite', 'date_added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 7, 1, 0, 0), blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Favorite.date_added'
        db.delete_column('udj_favorite', 'date_added')
