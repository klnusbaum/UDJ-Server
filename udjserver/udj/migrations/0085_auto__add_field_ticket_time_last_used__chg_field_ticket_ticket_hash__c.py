...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.time_last_used'
        db.add_column('udj_ticket', 'time_last_used',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 5, 17, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Ticket.ticket_hash'
        db.alter_column('udj_ticket', 'ticket_hash', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64))

        # Changing field 'Ticket.time_issued'
        db.alter_column('udj_ticket', 'time_issued', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    def backwards(self, orm):
        # Deleting field 'Ticket.time_last_used'
        db.delete_column('udj_ticket', 'time_last_used')


        # Changing field 'Ticket.ticket_hash'
        db.alter_column('udj_ticket', 'ticket_hash', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True))

        # Changing field 'Ticket.time_issued'
        db.alter_column('udj_ticket', 'time_issued', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    models = {
        'auth.group': {
        ...
        'udj.sortingalgorithm': {
            ...
            'uses_adder': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'uses_downvotes': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'uses_duration': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'uses_time_added': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'uses_upvotes': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        'udj.ticket': {
            'Meta': {'unique_together': "(('user', 'ticket_hash'),)", 'object_name': 'Ticket'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ticket_hash': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
            'time_issued': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'time_last_used': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'udj.vote': {
