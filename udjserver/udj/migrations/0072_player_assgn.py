...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
      for playlist_entry in orm.ActivePlaylistEntry.objects.all():
        default_library = orm.DefaultLibrary.objects.get(library=playlist_entry.library)
        playlist_entry.player=default_library.player
        playlist_entry.save()
