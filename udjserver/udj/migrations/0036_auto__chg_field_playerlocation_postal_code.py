...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlayerLocation.postal_code'
        db.alter_column('udj_playerlocation', 'postal_code', self.gf('django.db.models.fields.CharField')(max_length=20))
    def backwards(self, orm):

        # Changing field 'PlayerLocation.postal_code'
        db.alter_column('udj_playerlocation', 'postal_code', self.gf('django.db.models.fields.CharField')(max_length=100))
    models = {
        'auth.group': {
