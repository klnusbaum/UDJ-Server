...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlayerLocation.latitude'
        db.delete_column('udj_playerlocation', 'latitude')

        # Deleting field 'PlayerLocation.longitude'
        db.delete_column('udj_playerlocation', 'longitude')

    def backwards(self, orm):
        # Adding field 'PlayerLocation.latitude'
        db.add_column('udj_playerlocation', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'PlayerLocation.longitude'
        db.add_column('udj_playerlocation', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)
