...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('udj_favorite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('favorite_song', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.LibraryEntry'])),
        ))
        db.send_create_signal('udj', ['Favorite'])

    def backwards(self, orm):
        # Deleting model 'Favorite'
        db.delete_table('udj_favorite')
