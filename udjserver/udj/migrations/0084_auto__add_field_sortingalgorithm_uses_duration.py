...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SortingAlgorithm.uses_duration'
        db.add_column('udj_sortingalgorithm', 'uses_duration',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SortingAlgorithm.uses_duration'
        db.delete_column('udj_sortingalgorithm', 'uses_duration')
