...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SongSetEntry'
        db.create_table('udj_songsetentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('songset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.SongSet'])),
            ('song', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.LibraryEntry'])),
        ))
        db.send_create_signal('udj', ['SongSetEntry'])

    def backwards(self, orm):
        # Deleting model 'SongSetEntry'
        db.delete_table('udj_songsetentry')
