...
from udj.trans_migration_constants import US_COUNTRY_NAME
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.country'
        uscountry = orm.Country.objects.get(name__iexact=US_COUNTRY_NAME)
        db.add_column('udj_state', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=uscountry.id, to=orm['udj.Country']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'State.country'
        db.delete_column('udj_state', 'country_id')
