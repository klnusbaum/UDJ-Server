    ...
    def forwards(self, orm):
        ...
        for entry in orm.LibraryEntry.objects.all():
          if entry.is_banned:
            ...
            newban = orm.BannedLibraryEntry(player=default_library.player, song=entry)
            newban.save()


    def backwards(self, orm):
        "Write your backwards methods here."
        for banned_song in orm.BannedLibraryEntry.objects.all():
          actual_song = banned_song.song
          actual_song.is_banned = True
          actual_song.save()
