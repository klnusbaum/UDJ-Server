...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LibraryEntry.lib_song_id'
        db.delete_column('udj_libraryentry', 'lib_song_id')

    def backwards(self, orm):
        # Adding field 'LibraryEntry.lib_song_id'
        db.add_column('udj_libraryentry', 'lib_song_id',
