...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlayerAdmin'
        db.create_table('udj_playeradmin', (
        ...
        db.send_create_signal('udj', ['PlayerAdmin'])

        # Adding unique constraint on 'PlayerAdmin', fields ['admin_user', 'player']
        db.create_unique('udj_playeradmin', ['admin_user_id', 'player_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'PlayerAdmin', fields ['admin_user', 'player']
        db.delete_unique('udj_playeradmin', ['admin_user_id', 'player_id'])

        # Deleting model 'PlayerAdmin'
        db.delete_table('udj_playeradmin')
