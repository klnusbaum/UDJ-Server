...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivePlaylistEntry.player'
        db.add_column('udj_activeplaylistentry', 'player',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['udj.Player']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ActivePlaylistEntry.player'
        db.delete_column('udj_activeplaylistentry', 'player_id')
