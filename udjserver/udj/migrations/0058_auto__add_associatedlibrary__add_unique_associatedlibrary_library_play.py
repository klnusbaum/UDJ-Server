...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AssociatedLibrary'
        db.create_table('udj_associatedlibrary', (
        ...
        db.send_create_signal('udj', ['AssociatedLibrary'])

        # Adding unique constraint on 'AssociatedLibrary', fields ['library', 'player']
        db.create_unique('udj_associatedlibrary', ['library_id', 'player_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'AssociatedLibrary', fields ['library', 'player']
        db.delete_unique('udj_associatedlibrary', ['library_id', 'player_id'])

        # Deleting model 'AssociatedLibrary'
        db.delete_table('udj_associatedlibrary')
    ...
    models = {
        ...
        'udj.externallibrary': {
            ...
            'external_lib_resolver_module': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
