...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Player', fields ['owning_user', 'name']
        db.create_unique('udj_player', ['owning_user_id', 'name'])

    def backwards(self, orm):
        # Removing unique constraint on 'Player', fields ['owning_user', 'name']
        db.delete_unique('udj_player', ['owning_user_id', 'name'])
