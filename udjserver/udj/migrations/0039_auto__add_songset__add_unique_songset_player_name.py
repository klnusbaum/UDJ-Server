...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SongSet'
        db.create_table('udj_songset', (
        ...
        db.send_create_signal('udj', ['SongSet'])

        # Adding unique constraint on 'SongSet', fields ['player', 'name']
        db.create_unique('udj_songset', ['player_id', 'name'])

    def backwards(self, orm):
        # Removing unique constraint on 'SongSet', fields ['player', 'name']
        db.delete_unique('udj_songset', ['player_id', 'name'])

        # Deleting model 'SongSet'
        db.delete_table('udj_songset')
