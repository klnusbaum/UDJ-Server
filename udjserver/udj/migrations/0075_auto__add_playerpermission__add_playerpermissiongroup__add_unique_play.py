...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlayerPermission'
        db.create_table('udj_playerpermission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.Player'])),
            ('permission', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.PlayerPermissionGroup'])),
        ))
        db.send_create_signal('udj', ['PlayerPermission'])

        # Adding model 'PlayerPermissionGroup'
        db.create_table('udj_playerpermissiongroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.Player'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('udj', ['PlayerPermissionGroup'])

        # Adding unique constraint on 'PlayerPermissionGroup', fields ['player', 'name']
        db.create_unique('udj_playerpermissiongroup', ['player_id', 'name'])

        # Adding model 'PlayerPermissionGroupMember'
        db.create_table('udj_playerpermissiongroupmember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('permission_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.PlayerPermissionGroup'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('udj', ['PlayerPermissionGroupMember'])

    def backwards(self, orm):
        # Removing unique constraint on 'PlayerPermissionGroup', fields ['player', 'name']
        db.delete_unique('udj_playerpermissiongroup', ['player_id', 'name'])

        # Deleting model 'PlayerPermission'
        db.delete_table('udj_playerpermission')

        # Deleting model 'PlayerPermissionGroup'
        db.delete_table('udj_playerpermissiongroup')

        # Deleting model 'PlayerPermissionGroupMember'
        db.delete_table('udj_playerpermissiongroupmember')
    ...
    models = {
        ...
        'udj.userpubkey': {
            'Meta': {'object_name': 'UserPubKey'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_key': ('django.db.models.fields.CharField', [], {'max_length': '372'}),
