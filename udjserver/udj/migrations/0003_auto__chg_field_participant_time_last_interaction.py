...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participant.time_last_interaction'
        db.alter_column('udj_participant', 'time_last_interaction', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
    def backwards(self, orm):

        # Changing field 'Participant.time_last_interaction'
        db.alter_column('udj_participant', 'time_last_interaction', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    models = {
        'auth.group': {
