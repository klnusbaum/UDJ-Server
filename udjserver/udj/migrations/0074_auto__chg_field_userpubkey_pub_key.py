...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserPubKey.pub_key'
        db.alter_column('udj_userpubkey', 'pub_key', self.gf('django.db.models.fields.CharField')(max_length=372))
    def backwards(self, orm):

        # Changing field 'UserPubKey.pub_key'
        db.alter_column('udj_userpubkey', 'pub_key', self.gf('django.db.models.fields.CharField')(max_length=256))
    models = {
        'auth.group': {
