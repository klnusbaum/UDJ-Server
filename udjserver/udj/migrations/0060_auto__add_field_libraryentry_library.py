...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LibraryEntry.library'
        db.add_column('udj_libraryentry', 'library',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.Library'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'LibraryEntry.library'
        db.delete_column('udj_libraryentry', 'library_id')
    ...
    models = {
        ...
        'udj.libraryentry': {
            ...
            'library': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['udj.Library']", 'null': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['udj.Player']"}),
