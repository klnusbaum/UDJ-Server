...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlaylistEntryTimePlayed.playlist_entry'
        db.alter_column('udj_playlistentrytimeplayed', 'playlist_entry_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['udj.ActivePlaylistEntry'], unique=True))
    def backwards(self, orm):

        # Changing field 'PlaylistEntryTimePlayed.playlist_entry'
        db.alter_column('udj_playlistentrytimeplayed', 'playlist_entry_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.ActivePlaylistEntry'], unique=True))
    models = {
        'auth.group': {
