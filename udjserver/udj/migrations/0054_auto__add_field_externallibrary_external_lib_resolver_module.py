...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalLibrary.external_lib_resolver_module'
        db.add_column('udj_externallibrary', 'external_lib_resolver_module',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ExternalLibrary.external_lib_resolver_module'
        db.delete_column('udj_externallibrary', 'external_lib_resolver_module')
