...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SortingAlgorithm.uses_adder'
        db.add_column('udj_sortingalgorithm', 'uses_adder',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SortingAlgorithm.uses_time_added'
        db.add_column('udj_sortingalgorithm', 'uses_time_added',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SortingAlgorithm.uses_upvotes'
        db.add_column('udj_sortingalgorithm', 'uses_upvotes',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SortingAlgorithm.uses_downvotes'
        db.add_column('udj_sortingalgorithm', 'uses_downvotes',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SortingAlgorithm.uses_adder'
        db.delete_column('udj_sortingalgorithm', 'uses_adder')

        # Deleting field 'SortingAlgorithm.uses_time_added'
        db.delete_column('udj_sortingalgorithm', 'uses_time_added')

        # Deleting field 'SortingAlgorithm.uses_upvotes'
        db.delete_column('udj_sortingalgorithm', 'uses_upvotes')

        # Deleting field 'SortingAlgorithm.uses_downvotes'
        db.delete_column('udj_sortingalgorithm', 'uses_downvotes')
