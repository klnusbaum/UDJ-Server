...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.kick_flag'
        db.add_column('udj_participant', 'kick_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Participant.ban_flag'
        db.add_column('udj_participant', 'ban_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Participant.kick_flag'
        db.delete_column('udj_participant', 'kick_flag')

        # Deleting field 'Participant.ban_flag'
        db.delete_column('udj_participant', 'ban_flag')
