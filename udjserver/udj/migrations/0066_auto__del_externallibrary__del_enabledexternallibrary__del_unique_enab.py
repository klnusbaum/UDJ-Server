...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ExternalLibrary'
        db.delete_table('udj_externallibrary')

        # Deleting model 'EnabledExternalLibrary'
        db.delete_table('udj_enabledexternallibrary')

    def backwards(self, orm):
        # Adding model 'ExternalLibrary'
        db.create_table('udj_externallibrary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('external_lib_resolver_module', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('udj', ['ExternalLibrary'])
